...
class DocumentFour extends StatefulWidget {
  ...
  @override
  _DocumentFourState createState() => _DocumentFourState();
}

class _DocumentFourState extends State<DocumentFour> {
  int _current = 0;
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            FutureBuilder(
              future: getImage(context, 'sale-purchase.png'),
