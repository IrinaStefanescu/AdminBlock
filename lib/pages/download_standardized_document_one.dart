...
class DocumentOne extends StatefulWidget {
  ...
  @override
  _DocumentOneState createState() => _DocumentOneState();
}

class _DocumentOneState extends State<DocumentOne> {
  int _current = 0;
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              'This is a request to remove \npeople from house-keeping.',
